...
export default function ProductFormDrawer({
  ...
  useEffect(() => {
    ...
    const suggestedSellingPrice = totalProductCost ? Number((totalProductCost * 1.35).toFixed(2)) : 0;
    ...
    if (currentSection.key === "pricing") {
      return (
        <section className="catalog-form-stage">
          ...
          <Row gutter={[16, 18]}>
            <Col xs={24} lg={12}>
              <Form.Item label={renderFaqLabel("Selling Price", "selling-price")} name="price" rules={[{ required: true }]}>
                <InputNumber min={0} style={{ width: "100%" }} placeholder="0.00" disabled={!canSave} />
              </Form.Item>
            </Col>
            <Col xs={24} lg={12}>
            ...
            <Col xs={24}>
              <div className="catalog-form-section-heading">
                ...
                <span>Use these values to understand landed cost and price confidently.</span>
              </div>
            </Col>
            <Col xs={24} lg={12}>
            ...
            <Col xs={24}>
              <div className="catalog-cost-summary-card">
                ...
                <span>
                  Total product cost is calculated from purchase total, direct expenses, allocated batch expenses, and packaging. Suggested selling price starts at a 35% markup and can be adjusted before saving.
                </span>
              </div>
            </Col>
          </Row>
        ...
        <div className="catalog-modal-shell">
          ...
          <footer className="catalog-modal-footer">
            ...
            <div className="catalog-modal-footer-actions">
              ...
              <Button disabled={!canSave} onClick={() => handleSubmit(form.getFieldsValue(true), { workflowStatus: "draft" })}>
                Save as Draft
              </Button>
              <Button type="primary" loading={saving} disabled={!canSave} onClick={goNext}>
